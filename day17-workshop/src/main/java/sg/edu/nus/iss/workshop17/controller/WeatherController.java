...
public class WeatherController {
    ...
    @GetMapping
    public String getWeather(@RequestParam(required=true) String city, @RequestParam(defaultValue = "metric", required=false) String units, Model m) throws IOException {
