...
import sg.edu.nus.iss.Workshop14.service.AddressBookServer;
...
public class AddressBookController {
    ...
    @Autowired
    private AddressBookServer adrkbkSvc;
    ...
    public String getContactId(Model model, @PathVariable String contactId) {
        Contact ctc = adrkbkSvc.findById(contactId);
    ...
    public String getAllContacts(Model model, @RequestParam(defaultValue = "0") Integer startIndex) {
        List<Contact> ctcs = adrkbkSvc.findAll(startIndex);
