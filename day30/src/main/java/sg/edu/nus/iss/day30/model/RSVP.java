...
public class RSVP  implements Serializable {
    ...
    public void setConfirmationDate(DateTime confirmation_date) {
    ...
    // map returned rowset/resultset from sql database into POJO
