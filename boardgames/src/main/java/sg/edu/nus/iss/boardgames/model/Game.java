package sg.edu.nus.iss.boardgames.model;
...
public class Game {
    ...
    public void setUser_rated(Integer users_rated) {
        this.users_rated = users_rated;
    }
    ...
    public static Game create(Document d){
        ...
        game.setUser_rated(d.getInteger("users_rated"));
